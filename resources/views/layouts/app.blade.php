...
<head>
    ...
    <title>{{ config('app.name', 'MT MARKET PLACE') }}</title>
...
<body>
    <div id="app">
        <nav style="color:white;" class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'MT MARKET PLACE') }}
                </a>
