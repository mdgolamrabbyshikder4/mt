    ...
    <div class="row justify-content-center mt-0">
        <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <h2><strong>Service Create</strong></h2>
                <p>Fill all form field to go to next step</p>
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" 
                        action="{{url('/client/service')}}"
                        ...
                        @CSRF
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <input type="text" name="title" id="title" placeholder="Please Enter your title"/><br><br>
                                    ...
                                    <input type="text" name="tag" id="tag" placeholder="Please Enter your tag"/><br><br>
                                </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <input type="text" name="firstpakagetitle" id="fpakagetitle" placeholder="First Pakage Title"/><br><br>
                                    <label for="fpakageprice">First Pakage Price</label><br><br>
                                    <input type="number" name="firstpakageprice" id="fpakageprice" ><br><br>

                                    <label for="spakagetitle">Secend Pakage Title</label><br><br>
                                    <input type="text" name="secendpakagetitle" id="spakagetitle" placeholder="Second Pakage Title"/><br><br>
                                    <label for="spakageprice">Secend Pakage Price</label><br><br>
                                    <input type="number" name="secondpakageprice" id="spakageprice" ><br><br>

                                    <label for="spakagetitle">Third Pakage Title</label><br><br>
                                    <input type="text" name="thirdpakagetitle" id="spakagetitle" placeholder="Third Pakage Title"/><br><br>
                                    <label for="tpakageprice">Third Pakage Price</label><br><br>
                                    <input type="number" name="sthirdpakageprice" id="tpakageprice" ><br><br>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <textarea name="discription" id="discription" rows="10"></textarea><br><br>

                                    <label class="reqerment">Requirnment</label>
                                    <input type="text" name="reqerment" id="reqerment" placeholder="Enter your Requirnment">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title text-center">Image and publish</h2>
                                    <br><br>
